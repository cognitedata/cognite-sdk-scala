...
object DummyFilter {
  implicit val dummyFilterCodec: JsonValueCodec[DummyFilter] = JsonCodecMaker.make[DummyFilter]
}

class FilterTest extends SdkTestSpec with OptionValues {
  private implicit val dummyFilterRequestCodec: JsonValueCodec[FilterRequest[DummyFilter]] = JsonCodecMaker.make[FilterRequest[DummyFilter]]
  private implicit val dummyFilterRequestCodec: JsonValueCodec[FilterRequest[DummyFilter]] = JsonCodecMaker.make[FilterRequest[DummyFilter]]
